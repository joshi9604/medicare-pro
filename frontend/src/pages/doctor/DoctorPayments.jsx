...
// import { CalendarDays, CheckCircle2, CreditCard, Hourglass, Stethoscope, Video } from 'lucide-react';
...
//       if (filter === 'pending') return payment.status === 'created' || payment.appointment?.status === 'pending';
//       return true;
//     });
...
//         <h1 className="doctor-payments-title"><CreditCard size={24} /> Payment History</h1>
...
//         <div>
//           <h1 className="doctor-payments-title"><CreditCard size={24} /> Payment History & Earnings</h1>
...
//           <div className="doctor-payments-stat-icon" style={{ background: '#e3f2fd' }}><CreditCard size={24} /></div>
//           <div className="doctor-payments-stat-content">
//             <div className="doctor-payments-stat-value">Rs{stats.total.toLocaleString('en-IN')}</div>
...
//           <div className="doctor-payments-stat-icon" style={{ background: '#dcfce7' }}><CheckCircle2 size={24} /></div>
//           <div className="doctor-payments-stat-content">
...
//           <div className="doctor-payments-stat-icon" style={{ background: '#fef3c7' }}><Hourglass size={24} /></div>
//           <div className="doctor-payments-stat-content">
...
//         <button onClick={() => setFilter('all')} className={`doctor-payments-filter-btn${filter === 'all' ? ' active' : ''}`} type="button">
//           All Payments
//           <span className="doctor-payments-badge">{payments.length}</span>
//         </button>
//         <button onClick={() => setFilter('paid')} className={`doctor-payments-filter-btn${filter === 'paid' ? ' active' : ''}`} type="button">
//           <CheckCircle2 size={15} /> Paid
//           <span className="doctor-payments-badge">{payments.filter((payment) => payment.status === 'paid').length}</span>
//         </button>
//         <button onClick={() => setFilter('pending')} className={`doctor-payments-filter-btn${filter === 'pending' ? ' active' : ''}`} type="button">
//           <Hourglass size={15} /> Pending
//           <span className="doctor-payments-badge">{payments.filter((payment) => payment.status === 'pending' || payment.appointment?.status === 'pending').length}</span>
//         </button>
//       </div>

//       {filteredPayments.length === 0 ? (
//         <div className="doctor-payments-empty">
//           <div className="doctor-payments-empty-icon"><CalendarDays size={44} /></div>
...
//                     <div className="doctor-payments-tx-id">{payment.razorpayPaymentId || payment.id.slice(0, 8)}</div>
//                   </td>
//                   <td className="doctor-payments-td" data-label="Patient">
//                     <div className="doctor-payments-patient-cell">
//                       <div className="doctor-payments-avatar">{payment.patient?.name?.[0] || 'P'}</div>
//                       <div>
//                         <div className="doctor-payments-patient-name">{payment.patient?.name || 'N/A'}</div>
//                         <div className="doctor-payments-appointment-id">APT: {payment.appointment?.appointmentId?.slice(0, 8) || 'N/A'}</div>
//                       </div>
//                     </div>
//                   </td>
...
//                       {payment.appointment?.type === 'telemedicine' ? <><Video size={14} /> Video</> : <><Stethoscope size={14} /> Clinic</>}
//                     </span>
//                   </td>
//                   <td className="doctor-payments-td" data-label="Amount">
//                     <strong className="doctor-payments-amount">Rs{payment.amount}</strong>
//                   </td>
...
//                       }}
//                     >
//                       {payment.status === 'paid' ? 'Paid' : payment.status === 'created' ? 'Pending' : payment.status}
//                     </span>
//                   </td>
//                   <td className="doctor-payments-td" data-label="Payment Method">
//                     {payment.method ? (
//                       <span className="doctor-payments-method" style={{ textTransform: 'uppercase', fontSize: '12px' }}>{payment.method}</span>
//                     ) : (
...
//               <span className="doctor-payments-summary-value">Rs{stats.total.toLocaleString('en-IN')}</span>
//             </div>
//             <div className="doctor-payments-summary-item">
...
//               <span className="doctor-payments-summary-value">Rs{stats.count > 0 ? Math.round(stats.total / stats.count) : 0}</span>
//             </div>
//           </div>
//         </div>
//       )}
