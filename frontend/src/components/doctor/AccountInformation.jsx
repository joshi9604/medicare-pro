    ...
    <div className="account-info-page">
      ...
      {!hasAccountInfo ? (
        <div className="account-info-alert">
          <div className="account-info-alert-icon">⚠️</div>
          <div>
        ...
        <div className="account-info-success">
          <div className="account-info-success-icon">✅</div>
          <div>
      ...
      <form onSubmit={handleSubmit} className="account-info-form">
        <div className="account-info-grid">
          ...
          <div className="account-info-group">
            <label className="account-info-label">Branch Name</label>
            <input
              type="text"
              name="branchName"
          ...
          <div className="account-info-group">
            <label className="account-info-label">UPI ID (Optional)</label>
            <input
              type="text"
              name="upiId"
        ...
        <div className="account-info-actions">
          <button type="submit" className="account-info-submit-btn" disabled={loading}>
            {loading ? 'Saving...' : hasAccountInfo ? 'Update Account' : 'Save Account Details'}
          </button>
        </div>
      </form>

      <div className="account-info-security">
        <div className="account-info-security-icon">🔒</div>
